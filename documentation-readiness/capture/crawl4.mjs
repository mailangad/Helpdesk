// Crawler v4 (was v3): opens each module by its real URL, then clicks every item in the
...
const SHOTS = path.join(OUT, 'screens4');
...
async function record(name) {
  ...
  fs.writeFileSync(path.join(OUT, 'app-inventory-v4.json'), JSON.stringify(inventory, null, 2));
